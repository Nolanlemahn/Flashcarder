...
init -1 python hide:
    ...
    config.window_title = u"Flashcarder"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Flashcarder"
    config.version = "v0.1.5_(0099)"
...
python early:
    config.save_directory = "Flashcarder-1412878393"
...
init python:
    ...
    build.directory_name = "Flashcarder-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Flashcarder"
    ...
    build.directory_name = "Flashcarder_" + config.version
